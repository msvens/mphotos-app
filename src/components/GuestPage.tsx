...
import LogoutGuestDialog from "./dialogs/LogoutGuestDialog";
    ...
    return (
        <div className={classes.root}>
            <div className={classes.paper}>
                ...
                <AddGuestDialog2 update={context.isGuest} name={context.guest.name} email={context.guest.email} open={showAddGuest} onClose={(res: boolean) => {setShowAddGuest(false)}}/>
